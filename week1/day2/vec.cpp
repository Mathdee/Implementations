/*
  DAY 2: Implementing the Rule of 5
==========================================
  Destructor (already have it)
  Copy constructor — Vec(const Vec& other)
  Copy assignment — Vec& operator=(const Vec& other)
  Move constructor — Vec(Vec&& other) noexcept
  Move assignment — Vec& operator=(Vec&& other) noexcept
*/
#include <iostream>
#include <cassert>
#include <cstddef>
